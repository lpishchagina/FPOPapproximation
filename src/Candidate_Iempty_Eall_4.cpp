...
void Candidate_Iempty_Eall_4::UpdateOfCandidate(unsigned int t, std::vector<std::list<Candidate_Iempty_Eall_4>::reverse_iterator> &vectlinktocands){
  Cost cost = Cost(Dim);
