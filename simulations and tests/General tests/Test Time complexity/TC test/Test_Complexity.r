...
# approximation = 'rectangle', intersection = 'empty', exclusion = 'all'        +2
...
# approximation = 'rectangle', intersection = 'last', exclusion = 'all'         +2(using vector of links) +2,3
...
# approximation = 'rectangle', intersection = 'last', exclusion = 'ramdom'      +2
# approximation = 'rectangle', intersection = 'random', exclusion = 'all'       +2
# approximation = 'rectangle', intersection = 'random', exclusion = 'random'    +2

# Simple-approximation---------

# approximation = 'sphere', intersection = 'last', exclusion = 'all'            +2
...
NumberOfSimulations <- 7                                                        # you can choose Number of simulation for calculation of Runtime Mean
